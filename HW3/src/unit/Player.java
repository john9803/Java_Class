...
public class Player extends Unit {
    ...
    int diceValue1 = (int) (Math.random() * Constant.PLAYER_DICE_NUM) + 1;
    int diceValue2 = (int) (Math.random() * Constant.PLAYER_DICE_NUM) + 1;
    int diceValue3 = (int) (Math.random() * Constant.PLAYER_DICE_NUM) + 1;
    ...
    public void rollDice() {
        ...
        switch (this.roll_num) {
            ...
            case 1:
                ...
                this.gstate.player.setCnt(this.gstate.player.getCnt() + this.avgValue);
